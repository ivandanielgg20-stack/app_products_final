  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color.fromARGB(108, 8, 7, 7),
...
class _Square extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      height: borderSize,
      decoration: const BoxDecoration(
        color: Color.fromARGB(115, 190, 192, 90),
      ),
    );
  }
}
...
class _RightTrianglePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
      ..color = const Color.fromARGB(174, 194, 75, 75)
...
class _LeftTrianglePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
      ..color = const Color.fromARGB(134, 194, 49, 182)
      ..style = PaintingStyle.fill;
...
class _DiamondPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
      ..color = const Color.fromARGB(108, 110, 14, 148)
      ..style = PaintingStyle.fill;
...
class _SemiCirclePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
      ..color = const Color.fromARGB(132, 56, 182, 31)
      ..style = PaintingStyle.fill;
...
class _SemiCircleInvertedPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final paint = Paint()
      ..color = const Color.fromARGB(108, 160, 56, 56)
      ..style = PaintingStyle.fill;
